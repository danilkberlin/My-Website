                            ...
                            <Form>
                                ...
                                <Row className='my-3'>
                                    <Col md={3} xs={12} className='align-items-center'>
                                        <Button className='anim-button rounded-4 w-100 text-center' variant="px-4 py-2" >Send Messeage <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
