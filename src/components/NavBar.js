    ...
    <>
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <Button type="submit" className='anim-button  rounded-4'>Send Messeage <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send" viewBox="0 0 16 16">
