                                                    ...
                                                    <div className='justify-content-center background-cards-about p-3'>
                                                        <Row className=" align-items-center my-2">
                                                            ...
                                                            <Col md={10} xs={8} className="p-0">
                                                                ...
                                                                <p className="m-0"><span className="grau-text">SEO in </span>Creativen People</p>
                                                        ...
                                                        <Row className="my-3">
                                                            <Col>
                                                                <button className="button-dark-mode rounded-4 px-4 py-1">Project Page <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
